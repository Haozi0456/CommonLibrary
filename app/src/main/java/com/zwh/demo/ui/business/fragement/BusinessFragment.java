...
import com.zwh.demo.ui.business.adapter.BusinessListAdapter;
...
//        titleBar.setTitleText("产品列表");
        ...
        adapter = new BusinessListAdapter(R.layout.item_buiness_layout, null);
            ...
            public void onSimpleItemClick(BaseQuickAdapter adapter, View view, int position) {
                ...
                if (bean != null ) {
                    if(type == 0){
                        ...
                        Intent intent = new Intent(); //调用浏览器打开
    ...
    public void onRefresh() {
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                String data = "";
                if(type == 0){
                    data = getJson(context,"products.json");
                }else if(type == 1){
                    data = getJson(context,"business_bwg.json");
                }else if(type == 2){
                    data = getJson(context,"business_szkg.json");
                }else if(type == 3){
                    data = getJson(context,"business_whyc.json");
                }

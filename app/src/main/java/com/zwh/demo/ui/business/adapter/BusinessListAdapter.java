...
public class BusinessListAdapter extends BaseQuickAdapter<NewsBean,BaseViewHolder> {

    public BusinessListAdapter(int layoutResId, List<NewsBean> data) {
...
//                .into(imageView);
        ...
        RequestOptions options = new RequestOptions()
                ...
                .error(R.drawable.icon_preload)
                .centerCrop();
        Glide.with(GApp.getAppContext()).load(bean.getIcon()).apply(options).transition(DrawableTransitionOptions.withCrossFade()).into(imageView);

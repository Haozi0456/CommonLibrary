...
public class BusinessDetailsActivity extends AppCompatActivity {
    ...
    private void initData() {
        bean = (InfoBean) getIntent().getSerializableExtra("bean");
...
//        Glide.with(GAPP.getAppContext()).load(bean.getImgurl()).diskCacheStrategy(DiskCacheStrategy.ALL).error(R.drawable.icon_preload).crossFade().into(detailImg);
...
//    }
    ...
    @OnClick({R.id.fab,R.id.toCommentView, R.id.shareButton})
...
//        oks.setTitleUrl(bean.getImgurl());
//        // text是分享文本，所有平台都需要这个字段
//        oks.setText(bean.getAbstruct() + " " + bean.getImgurl());
//        // imagePath是图片的本地路径，Linked-In以外的平台都支持此参数
////        oks.setImagePath(context.getExternalFilesDir(null).getPath() + bean.getImgurl());//确保SDcard下面存在此张图片
//        // url仅在微信（包括好友和朋友圈）中使用
//        oks.setUrl(bean.getImgurl());
//        // comment是我对这条分享的评论，仅在人人网和QQ空间使用
//        oks.setComment(bean.getAbstruct());
//        // site是分享此内容的网站名称，仅在QQ空间使用
//        oks.setSite(getString(R.string.app_name));
//        // siteUrl是分享此内容的网站地址，仅在QQ空间使用
//        oks.setSiteUrl(bean.getImgurl());
//
//        oks.setCallback(new cn.sharesdk.onekeyshare.OneKeyShareCallBack(handler));
//
//        // 启动分享GUI
//        oks.show(this);
    }
